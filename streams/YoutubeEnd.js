...
const MessageFormatter2_1 = require("../util/MessageFormatter2");
...
class YoutubeEnd {
    ...
    insert_liveChatMessages$(message, chatId) {
        let messageParts = MessageFormatter2_1.MessageFormatter.createMessageParts(message, YOUTUBE_MAX_MESSAGE_LENGTH);
